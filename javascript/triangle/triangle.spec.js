...
describe('Triangle', () => {
  ...
  test('triangles with two negative sides are illegal', () => {
    const triangle = new Triangle(5, -2, -3);
    expect(triangle.kind.bind(triangle)).toThrow();
  });
  test('triangles with tree negative sides are illegal', () => {
    const triangle = new Triangle(-8, -4, -3);
    expect(triangle.kind.bind(triangle)).toThrow();
  });
});